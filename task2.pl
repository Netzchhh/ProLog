...
grade('Сидоров','PSY',4).
grade('Сидоркин','LP',4).
grade('Сидоркин','MTH',4).
grade('Сидоркин','FP',4).
grade('Сидоркин','INF',3).
grade('Сидоркин','ENG',4).
grade('Сидоркин','PSY',4).
grade('Биткоинов','LP',2).
grade('Биткоинов','MTH',2).
grade('Биткоинов','FP',2).
grade('Биткоинов','INF',2).
grade('Биткоинов','ENG',2).
grade('Биткоинов','PSY',2).
grade('Эфиркина','LP',2).
grade('Эфиркина','MTH',5).
grade('Эфиркина','FP',3).
...
grade('Круглотличников','LP',5).
grade('Круглотличников','MTH',5).
grade('Круглотличников','FP',5).
grade('Круглотличников','INF',5).
grade('Круглотличников','ENG',5).
...
average_grade_per_subject_alt :-
    ...
    findall(_, (
        ...
        Grades \= [], % проверяем наличие оценок
        sum_list(Grades, Sum),
